...
public class AggregationDemo {
    ...
    public static void main(String[] args) {
       ...
       f2.setNumerator(3); // change the fraction to make sure the copy of the field was returned
       ...
       f2.setNumerator(7); // change original fraction to make sure the deep copy was made
