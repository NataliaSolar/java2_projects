...
*/
    ...
    {
        //no need to try-catch, because we did that in Rectangle class
    ...
    @Override public boolean equals(Object otherObj)
   {
       ...
       ColoredBox a = (ColoredBox)otherObj;
       if (!super.equals(a)) return false;
       else{
           
       }
       if (height != a.height || color[0]!= a.color[0] || color[1]!= a.color[1] || color[2]!= a.color[3]) return false;
       return true;
   }
}
